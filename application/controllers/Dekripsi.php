        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($data_file['password'] == $password) {
                ...
                foreach ($arr_ciphertext as $i) {
                    $decrypt = $this->decrypt($i, $password);
                    $plaintext .= $this->read_bin($decrypt);
                    $ciphertext .= $this->read_bin($i);
                }
                ...
                $data_text['plaintext'] = $plaintext;

                $pdfgenerator = new Pdfgenerator();
                $pdfgenerator->loadHtml($this->load->view('Dekripsi/downloadPdf', $data_text));
