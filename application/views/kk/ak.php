...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="ml-1 mt-2 col-6">
            <a href="<?= base_url('kk/printanggota'); ?>"><button type="button" class="btn btn-danger" title="Print" onclick="return confirm('Yakin Cetak ?');"><i class="fas fa-print"></i> Cetak</button></a>
        </div>
        <div class="card-body">
