        ...
        <div class="card card-info mt-3">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <a href="<?= base_url('kk/tambah') ?>" class="btn btn-primary">
                            ...
                            <tbody>
                                ...
                                foreach ($kk as $kk) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('kk/ak/' . $kk['id_kk']); ?>"> <button type="button" class="btn btn-info" title="Detail"><i class="fas fa-users"></i></button></a>
