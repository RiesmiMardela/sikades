    ...
    <div class="card card-info mt-3">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-black">Laporan Data Kelahiran</h6>
            </div>
            <div class="card-body">
                ...
                <form method="get" action="">
                    ...
                    <a href="<?php echo base_url('laporan/kelahiran'); ?>">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="CetakModalLabel">Cetak</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="<?= base_url('laporan/printkelahiran'); ?>" method="post">
                        <table>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td>
                                    <a href="<?= base_url('laporan/printkelahiran'); ?>"><button type="button" class="btn btn-danger" title="Print" onclick="return confirm('Yakin Cetak ?');">
                                            <i class="fas fa-print"></i>Cetak</button>
                                        <a href="<?= base_url('laporan/printkelahiran'); ?>"><button type="button" class="btn btn-danger" title="Print" onclick="return confirm('Yakin Cetak ?');">
                                                <i class="fas fa-print"></i>Cetak Semua Data</button>
                                        </a>
                                </td>
                            </tr>
