        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <form method="get" action="">
                    ...
                    <a href="<?php echo base_url('superadmin/laporankelahiran'); ?>">
                ...
                <!-- <a href="<?= base_url('superadmin/printkelahiran'); ?>"><button type="button" class="btn btn-danger" title="Print" onclick="return confirm('Yakin Cetak ?');"><i class="fas fa-print"></i> Cetak</button></a> -->
