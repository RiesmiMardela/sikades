...
<div class="container-fluid">
    ...
    <div class="card card-info mt-3">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <a href="<?= base_url('superadmin/print'); ?>"><button type="button" class="btn btn-danger" title="Print" onclick="return confirm('Yakin Cetak ?');"><i class="fas fa-print"></i> Cetak</button></a>
